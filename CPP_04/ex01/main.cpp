...
/*   Updated: 2022/09/13 00:21:20 by einterdi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << animal[0]->getType() << " " << animal[0] << " " << animal[0]->_brain << std::endl;
	std::cout << animal[1]->getType() << " " << animal[1] << " " << animal[1]->_brain << std::endl;
	*(animal[1]) = *(animal[0]);
	std::cout << animal[0]->getType() << " " << animal[0] << " " << animal[0]->_brain << std::endl;
	std::cout << animal[1]->getType() << " " << animal[1] << " " << animal[1]->_brain << std::endl;
	animal[1]->printIdeas();
